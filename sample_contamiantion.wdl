...
task DownsampleAndReheader {
  # Define the input parameters for the task 
    ...
    String docker_image = "us.gcr.io/broad-dsp-lrma/mosdepth:sz_v3192024"
  ...
  runtime {
    ...
    disks: select_first([disk_space, "local-disk 500 HDD"])  # Use provided disk space or default to 500 GB
  }
